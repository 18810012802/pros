 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceService", targetNamespace = "http://ser.it.cn/", wsdlLocation = "http://114.248.80.234:6666/ws?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://ser.it.cn/", "MyWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://114.248.80.234:6666/ws?WSDL");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://ser.it.cn/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ser.it.cn/", "MyWebServicePort"), MyWebService.class, features);
    }
