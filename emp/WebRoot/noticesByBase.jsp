 ...
 <div id="i7"><div id="i8">
  ...
  <tr align="center">
   ...
   <th>类型</th>  
		 ...
		 <%
		  ...
		  %>
		   <tr>
             ...
             请选择查询依据：
       <select name="type1"><option value="all">全部</option><option value="newsno">记录号</option><option value="newstime">发布时间</option>
    ...
    <a href="/emp/news.do?type=selectByBase&pageNow=<%=i %>&base=<%=b[0] %>&basecon=<%=b[1] %>">[<%=i%>]</a>
    <%
    }
     %>
     </td>
