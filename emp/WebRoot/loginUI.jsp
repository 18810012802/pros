...
<form action="/emp/login.do?type1=login" method="post" class="STYLE-NAME">
<h1>登录窗口
...
<label>
<span>用户号 :</span>
<input id="name" type="text" name="userno" placeholder="" />
</label>
<label>
<span>密　码 :</span>
<input id="email" type="text" name="password" placeholder="" />
</label>

<label>
<span>类　型 :</span><select name="type">
