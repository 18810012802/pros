...
<html>
 ...
 <tr>
    ...
    <td><form action="/emp/repaire.do?type=addInfo" method="post"><div align="center">
   <table class="abc" width="100%"  border="1" bordercolor="#551A8B" cellpadding="0" cellspacing="0">
        
    <tr>
    <td colspan="3" align="center"><img src="images/bxjl.PNG" width="149" height="63" /></td>
    </tr>
   <tr>
 ...
 <option selected>寝室号
     ...
     <tr>
             <td height="5" colspan="3" bgcolor="#F0F0F0">&nbsp;</td> 
          </tr>
    </table>
  ...
  <td>园号</td>  
   ...
   <td>删除</td>
		 ...
		 <tr align="center">
		  ...
		  <td><%=ib.getProname() %>  <td><%=ib.getCause() %></td> <td><%=ib.getSubtime() %></td> <td><%=ib.getSolvetime() %></td>
		  <td><%=ib.getCost()%></td> <td><%=(ib.getRemark()==null?"":ib.getRemark()) %></td> 
		  		  <td><a href="/emp/repaire.do?type=updateInfo&recordno=<%=ib.getRecordno()%>">修改</a></td>
		  <td><a href="/emp/repaire.do?type=deleteInfo&recordno=<%=ib.getRecordno()%>">删除</a></td> 
		 </tr>
		 <%
		 }
		  ...
		  %>
		   <tr>
             ...
             <form action="/emp/repaire.do?type=selectByBase" method="post">
             请选择查询依据：
