...
<html>
 ...
 <tr>
    ...
    <td>
    <div align="center">
    <form action="/emp/news.do?type=manager" method="post">
<table width="60%" border="1" bordercolor="#551A8B" align="center" cellpadding="0" cellspacing="0" class="abc">
          ...
          <tr>
            ...
            <td width="50%"><input name="job" type="text" size="15" value="<%=ub.getJob() %> " /></td>
          </tr>
          ...
          <tr>
            ...
            <td width="50%"><input name="password" type="text" size="15" value="<%=ub.getPassword()%>"/></td>
          </tr>
          ...
          <tr>
            ...
            <td><input name="address" type="text" size="23" value="<%=ub.getAddress()%>" /></td>
          </tr>
          ...
          <tr>
            ...
            <td><input name="email" type="text" size="23" value="<%=ub.getEmail()%>"/></td>
          </tr>
         
          <tr>
            <td align="right">邮&nbsp;&nbsp;编：</td>
            <td><input name="postcode" type="text" size="15" value="<%=ub.getPostcode()%>"/></td>
          </tr>
